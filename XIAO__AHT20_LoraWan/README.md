# XIAO ESP32S3 + Wio-SX1262 LoRaWAN + AHT20

Petit projet Arduino pour envoyer périodiquement une mesure de température et d’humidité via LoRaWAN avec un Seeed XIAO ESP32S3, un Wio-SX1262 et un AHT20.
